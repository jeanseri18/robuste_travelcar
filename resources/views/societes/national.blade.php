...
@section('title', 'Sociétés Nationales | TravelCar225')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                ...
                Sociétés de Transport National
            </h1>
            <p class="text-muted mb-0">Gérez les sociétés de transport opérant au niveau national</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('societes.national.create') }}" class="btn btn-success btn-lg shadow-sm">
                <i class="bi bi-plus-circle me-2"></i> Ajouter Société Nationale
            </a>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $societes->sum(function($s) { return $s->destinationsNational->count(); }) }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="card-header bg-success py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-white">
                    ...
                    Liste des Sociétés Nationales
                </h6>
                <span class="badge bg-light text-success">{{ $societes->count() }} sociétés</span>
            </div>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="Table" width="100%" cellspacing="0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th><strong><i class="bi bi-flag me-1"></i>Type</strong></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-success rounded-pill">
                                        <i class="bi bi-flag me-1"></i>National
                                    </span>
                                </td>
                                <td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Êtes-vous sûr de vouloir supprimer la société nationale <strong>{{ $societe->nom_commercial }}</strong> ?
                                                    <br>
