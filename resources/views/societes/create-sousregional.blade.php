...
@section('title', 'Créer une Société Sous-Régionale | TravelCar225')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                ...
                Créer une Société de Transport Sous-Régionale
            </h1>
            <p class="text-muted mb-0">Ajouter une nouvelle société de transport opérant au niveau sous-régional</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('societes.sousregional') }}" class="btn btn-outline-primary btn-lg shadow-sm">
                <i class="bi bi-arrow-left me-2"></i> Retour aux Sociétés Sous-Régionales
            </a>
    ...
    <div class="card shadow-lg border-0 mb-4">
        <div class="card-header bg-primary text-white py-3">
            <h6 class="m-0 font-weight-bold d-flex align-items-center">
                ...
                Formulaire de création de société sous-régionale
            </h6>
        </div>
        <div class="card-body">
            <form action="{{ route('societes.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="type" value="sousregional">
                ...
                <div class="d-grid gap-2 mt-4">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="bi bi-globe me-2"></i> Créer la société sous-régionale
                    </button>
                </div>
            </form>
        </div>
