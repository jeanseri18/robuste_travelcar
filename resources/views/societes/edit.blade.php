...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modifier une Société de Transport</h1>
        <div>
            <a href="{{ route('societes.show', $societe->id) }}" class="btn btn-info">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulaire de modification de société</h6>
        </div>
        <div class="card-body">
