...
@section('title', 'Sociétés Sous-Régionales | TravelCar225')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                ...
                Sociétés de Transport Sous-Régional
            </h1>
            <p class="text-muted mb-0">Gérez les sociétés de transport opérant au niveau sous-régional</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('societes.sousregional.create') }}" class="btn btn-primary btn-lg shadow-sm">
                <i class="bi bi-plus-circle me-2"></i> Ajouter Société Sous-Régionale
            </a>
            <a href="{{ route('societes.index') }}" class="btn btn-outline-primary btn-lg">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $societes->sum(function($s) { return $s->destinationsSousRegion->count(); }) }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $societes->sum(function($s) { return $s->reservations->count(); }) }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="card-header bg-warning py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-white">
                    ...
                    Liste des Sociétés Sous-Régionales
                </h6>
                <span class="badge bg-light text-warning">{{ $societes->count() }} sociétés</span>
            </div>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="Table" width="100%" cellspacing="0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th><strong><i class="bi bi-globe me-1"></i>Type</strong></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-warning rounded-pill">
                                        <i class="bi bi-globe me-1"></i>Sous-Régional
                                    </span>
                                </td>
                                <td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Êtes-vous sûr de vouloir supprimer la société sous-régionale <strong>{{ $societe->nom_commercial }}</strong> ?
                                                    <br>
