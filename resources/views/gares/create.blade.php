    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="bi bi-building-add text-info me-2"></i>
                Créer une Gare
            </h1>
            <p class="text-muted mb-0">Ajouter une nouvelle gare ou station de transport</p>
        </div>
        <a href="{{ route('gares.index') }}" class="btn btn-outline-secondary btn-lg shadow-sm">
    ...
    <div class="card shadow-lg border-0 mb-4">
        <div class="card-header bg-info text-white py-3">
            <h6 class="m-0 font-weight-bold d-flex align-items-center">
                ...
                Formulaire de création de gare
            </h6>
        </div>
        <div class="card-body">
